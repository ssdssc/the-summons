...
async function main() {
  const schoolName = 'Royal College';
  ...
  const membersData = [
    { registration_id: reg.id, name: 'Bumith Vithanage', subject: 'physics', is_captain: true, access_code: 'PHY-T49W' },
    { registration_id: reg.id, name: 'Sathruwan Herath', subject: 'maths', is_captain: false, access_code: 'MAT-HYBB' },
    { registration_id: reg.id, name: 'Sanupa Perera', subject: 'biology', is_captain: false, access_code: 'BIO-BN83' },
    { registration_id: reg.id, name: 'Vishwa Kalpana', subject: 'chemistry', is_captain: false, access_code: 'CHE-4PHF' }
  ];
