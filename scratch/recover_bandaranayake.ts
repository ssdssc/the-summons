...
async function main() {
  const schoolName = 'Bandaranayake College';
  ...
  const membersData = [
    { registration_id: reg.id, name: 'Deneth Dilpahan', subject: 'maths', is_captain: true, access_code: 'MAT-MQ3T' },
    { registration_id: reg.id, name: 'Nadil Nimadith', subject: 'physics', is_captain: false, access_code: 'PHY-SA2Q' },
    { registration_id: reg.id, name: 'Anuk Enuka', subject: 'chemistry', is_captain: false, access_code: 'CHE-VN6X' },
    { registration_id: reg.id, name: 'Udantha Indumina', subject: 'biology', is_captain: false, access_code: 'BIO-NXVW' }
  ];
